...
export default function HomePage() {
  ...
  return (
    <section className={styles.home}>
      <h1 className="text-center text-6xl mb-10 translation">Welcome to FashionHub! <span>欢迎来到FashionHub！</span> </h1>
      <div className={styles.home__container}>
        ...
        <div className={classnames(styles.home__container__content)}>
          <h1 className="max-w-xl text-center translation">Discover the Latest Fashion Trends at FashionHub <span>在 FashionHub 发现最新时尚趋势</span></h1>
          <div className={classnames(styles['home__container__content-desc'], 'max-w-xl', 'translation')}>
            {contentDesc[current].desc}
